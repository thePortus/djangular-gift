...
angular.module('core')
    .filter('passwordStrengthStatus', passwordStrengthStatusFilter)
    .directive('passwordStrength', passwordStrengthDirective);

function passwordStrengthStatusFilter(passwordStrength) {
...
function passwordStrengthDirective($log, passwordStrength, staticPath) {
    return {
        require: 'ngModel',
